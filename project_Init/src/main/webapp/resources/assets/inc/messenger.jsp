...
<div id="open_messenger" class="card-box md" style="height:530px !important; width:550px; display:none; flex-direction: column;">
	<div class="card">
		<div class="card-header" style="flex:0.1;">
		<h4 class="card-title">MESSENGER</h4>
		</div>	
		<div class="card-body" style="flex:0.9;">
			<div class="messenger_body" style="height:477px;">
				<!-- 메뉴 -->
